...
//**************config**********************
#define CALLSIGN "XXXX" // znak nadawany RTTY
#define APRS_CALLSIGN "XXXX" // znak nadawany APRS min. 6 znakow (jeśli nie dodaj spację)
...
#define APRS_COMMENT " Radiosonda RS/41 Modificata "
#define RTTY_TO_APRS_RATIO 1 // czestotliwosc wysyłania ramek APRS - standardowo: 3 x RTTY > 1 x APRS
//*************TX Frequencies********************
